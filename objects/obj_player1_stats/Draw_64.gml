...
if(hp != maxhp)             draw_text_outline(32, 32, "Health: "     + string(hp)      + "/" + string(maxhp), 1, c_dkgray, 5); 
else                        draw_text_outline(32, 32, "Health: "     + string(hp)      + "/" + string(maxhp), 1, c_red, 5); 
if(stamina != maxstamina)   draw_text_outline(32, 48, "Stamina: "    + string(stamina) + "/" + string(maxstamina), 1, c_dkgray, 5);
else                        draw_text_outline(32, 48, "Stamina: "    + string(stamina) + "/" + string(maxstamina), 1, c_blue, 5);
if(mana != maxmana)         draw_text_outline(32, 64, "Mana: "       + string(mana)    + "/" + string(maxmana), 1, c_dkgray, 5);  
else                        draw_text_outline(32, 64, "Mana: "       + string(mana)    + "/" + string(maxmana), 1, c_navy, 5);        
if(expr != maxexpr)         draw_text_outline(32, 80, "Experience: " + string(expr)    + "/" + string(maxexpr), 1, c_dkgray, 5);
else                        draw_text_outline(32, 80, "Experience: " + string(expr)    + "/" + string(maxexpr), 1, c_olive, 5);
draw_text_outline(32, 96, "Level: "      + string(level), 1, c_dkgray, 5);                                  
